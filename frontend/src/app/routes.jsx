...
// اصلاح شده: استفاده از مسیر صحیح برای نمودار
...
const SalesTable = Loadable(lazy(() => import("./views/material-kit/reports/sales/SalesTable")));
