...
return new class extends Migration
{
    public function up()
    {
        Schema::create('sales_items', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('supplier_id'); // Foreign key to registrations (reg_type = supplier)
            ...
            $table->foreign('supplier_id')->references('reg_id')->on('registrations')->onDelete('cascade'); // ✅ تغییر به registrations
